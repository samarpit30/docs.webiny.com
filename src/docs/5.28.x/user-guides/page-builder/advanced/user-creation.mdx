...
Similar to [User Creation](../link) in Headless CMS, Webiny allows you to add multiple users to the application with different access permissions to Page Builder. In this tutorial, we will learn how to create a user group with custom access permissions to the Page Builder. Then we will create a user within that user group.

As an example, we will create a user group with the following access permissions:

- Permission to view, create, and update all the page categories in Page Builder.
- Permission to view, create, and update all the menus in Page Builder.
- Permission to view, create, update, publish, and unpublish all the pages in Page Builder.
- Permission to view, create, and update all the block categories in Page Builder.
- Permission to view, create, update, and unlink all the blocks in Page Builder.
...
6. Under the **BLOCK CATEGORIES** section:

    a. In the **Access Scope** dropdown, click **All content**.

    b. In the **Primary Actions** dropdown, click **Read, write**.

7. Under the **BLOCK CONTENT** section:
...
8. Under the **SETTINGS** section, in the **Access Level** dropdown in front of **Manage settings**, select **No access**.
