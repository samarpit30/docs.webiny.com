...
Webiny's Page Builder comes with out-of-the-box functionality to create responsive pages. In this tutorial, we will learn how to make a page responsive in the page builder. We will do this in 2 steps:
...
In this step, we will modify the style of the page elements for tablet devices. If you are not familiar with how to edit the style of elements, please follow the [Create Page](../essentials/create-page) tutorial *(Ask Swapnil Sir if repetition here is fine)*.
