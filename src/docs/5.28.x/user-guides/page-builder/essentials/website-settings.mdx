...
1. Under the **Default Pages**, in the **Homepage** dropdown, select the page *you want as the homepage* (e.g. **The benefits of a Serverless CMS** - the page we created in the [Create Page](../essentials/create-page) tutorial).

2. Under the **Default Pages**, in the **Not found (404) page** dropdown, select the page *you want to be displayed* when a user visits a path URL on your website that does not exist (e.g. **Error 404**).
