...
Similar to [Content Entry Revisions](../link) in Headless CMS, each modification made in a page (in page builder) that is saved or published is stored as a separate revision in Webiny. In this tutorial, we will learn how to create multiple revisions of a page and publish a specific revision. We will also learn how to create a new page version from a previous revision.
...
5. Now, following Steps 2 to 4, again update the paragraph text to:
    ...
    **And, a new version of a page can be made from a previous revision.**
...
3. To publish the **Page Revisions #2** revision, click the **Kebab Menu** ( ⁝ ) on it.
...
2. To create a new page version from the previous **Page Revisions #1** revision, click the **Kebab Menu** ( ⁝ ) on it.
