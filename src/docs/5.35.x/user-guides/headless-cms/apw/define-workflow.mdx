...
description: Learn how to define a workflow in Headless CMS.
---
...
Webiny enables you to create a personalized publishing workflow tailored to your needs. You can add as many review steps as necessary and define the scope of the workflow to suit your requirements. In this tutorial, we will learn how to define a workflow. We will do this in 3 steps:
...
If you are not familiar with how to create a content model group and a content model, please follow the [Create Content Model Group](../link) and [Create Content Model](../link) tutorials.
...
4. In the textbox, update the text from **Untitled** to **Blog Publishing Workflow**.
...
2. In the **Type** dropdown, click **Mandatory, non-blocking**.
    ...
    **Note**: There are three options in the **Type** dropdown:
    ...
    - **Optional**: This step doesn't impede the review process, and the page can be published regardless of sign-off. Choose this for steps that are supplementary or non-essential to the overall workflow. 
    

3. In the **Reviewers** section, select the checkbox(es) in front of the *reviewer's name(s)* (e.g. Neil Patel).
...
6. In the **CMS MODELS** tab, select the checkbox in front of **Blog**.
