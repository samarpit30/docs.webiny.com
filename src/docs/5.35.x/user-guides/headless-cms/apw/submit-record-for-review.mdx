...
- You need the **Content** content model group and **Blog** content model. If you don't have these, please follow the [Define Workflow](./define-workflow) tutorial to create them.
