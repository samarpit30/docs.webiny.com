...
To follow this tutorial, you need the **Content** content model group and **Blog** content model. If you don't have these, please follow the [Define Workflow](./define-workflow) tutorial to create them.


1. From the **Side Menu**, click **Headless CMS** > **CONTENT** > **Blog**.
...
3. In the **Title** textbox, type **Elevate Your Style: 5 Stylish Ways to Wear a Black T-Shirt for Men**.

4. In the **Slug** textbox, type **elevate-your-style-5-stylish-ways-to-wear-a-black-t-shirt-for-men**.

5. In the body of the blog, type the following:
