...
Webiny enables users to execute bulk actions, such as moving and deleting multiple files simultaneously. In this tutorial, we will learn how to move multiple files from folder to another folder in the File Manager.

## Prerequisites

To follow this tutorial, you need the **Men's Red Tshirt** and **Men's Black Tshirt** images uploaded in the file manager. If you don’t have these images in your file manager, please follow the [File Upload](../file-manager/upload-file) and [Tagging Files](../file-manager/tagging-files) tutorials to upload them.
