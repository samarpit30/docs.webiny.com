...
To follow this tutorial, you need to have a content model group named **E-commerce** in your Webiny instance. If you don't have it, please follow the [Create Content Model Group](/docs/{version}/user-guides/headless-cms/users/role-creation) tutorial to create it.
