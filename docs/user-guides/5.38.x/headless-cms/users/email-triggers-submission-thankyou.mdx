---
id: 
title: Submission and Thankyou Email Triggers
description: Learn how to use the Submission and Thankyou email triggers in Form Builder.
---
...
To follow this tutorial you need to have the form **Registration Form** in your Webiny instance. If you don't have it, please follow the [Create Multi-Step Form](/link) tutorial to create it.
